 ...
 *
 */
//https://github.com/semantic-web-software/dynagent/blob/a0d356169ef34f3d2422e235fed7866e3dda6d8a/Elecom/src/gdev/gfld/GTableColumn.java
...
public class DynamicTableColumn implements Comparable<DynamicTableColumn>{
	private static final Logger logger = LoggerFactory.getLogger(DynamicTableColumn.class);
	 /** El id de la columna*/
   ...
   // protected ArrayList<GValue> m_valuesPossible;
     ...
     */
    public DynamicTableColumn(String id,String idParent,int col,String strLab,int type,String ref/*,String claseCampo*/,int idProp,int width,int height,int length,String mask,boolean enable,boolean hide,boolean total,boolean agrupable,boolean dobleSizeHeader,boolean nullable,boolean creation,int finder,boolean basicEdition,boolean uniqueValue,Integer redondeo)
    {
        m_iId = id;
