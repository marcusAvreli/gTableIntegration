package gtableIntegration.gawt.utils;
...
public class PopupOptions{
	...
	public PopupOptions(ArrayList<JMenuItem> buttons, Component comp, ActionListener actionListenerHelp){
	...
	public static void main(String args[]){
		...
		b.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				PopupOptions p=new PopupOptions(labels,  null, null);
				p.show(true);
			}			
		});
		p.add(b);
